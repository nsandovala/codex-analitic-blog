  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-center px-6">
      ...
      <Link
        ...
        className="inline-block bg-yellow-400 text-black px-6 py-3 rounded-full font-semibold hover:bg-yellow-300 hover:scale-105 transition transform duration-300 shadow-lg"
      >
        Leer artículo →
      </Link>
    </main>
